...
import { FileText, Plus, Search, Edit3, Trash2, Eye, ExternalLink } from 'lucide-react';
            ...
            <main className="flex-1 p-8">
                <header className="flex justify-between items-center mb-10">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">Manage articles, guides, and educational content.</p>
                    </div>
                    <Button>
                        <Plus size={20} className="mr-2" /> Create New Article
                    </Button>
                </header>

                <div className="bg-white rounded-3xl premium-shadow border border-gray-100">
                    <div className="p-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/50">
                        <h3 className="font-bold text-gray-800">Articles & Guides</h3>
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {loading ? (
                                    ...
                                    <tr key={res.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <p className="text-xs font-semibold text-gray-600">{(res.author as any).name || 'Admin'}</p>
                                        </td>
